...
#' ## NAME
#'
#' **hyperhelp::hyperhelp**   help system with hypertext facilitites and table of contents outline
#' 
#' 
...
#' 
#' The **hyperhelp::hyperhelp** snit widget supports the following options which 
...
We use:
    ...
    * hyperhelp::hyperhelp [[package present hyperhelp::hyperhelp]]
}        
}

snit::widget ::hyperhelp::hyperhelp {
...
#' 
#' The *hyperhelp* package was written by Detlef Groth, University of Potsdam, Germany using Keith Vetters code from the Tclers Wiki as starting point.
#' 
    ...
    if {[llength $argv] >= 1 && [file exists [lindex $argv 0]]} {    
        ...
        if [catch {open $filename r} infh] {
            ...
            while {[gets $infh line] >= 0} {
                ...
                if {$flagex && [regexp {^\s*$} $line]}  {
                    break
                }
                if {$flagex && ![regexp {```} $line]} {
